import { cloneObj, getUniqueId } from '../util'
...
export function getOptionsFromState(file) {
...
export function getFileStateFromData(data) {
...
export function getBlankFileState(tabs, defaultEncoding = 'utf8', lineEnding = 'lf', markdown = '') {
...
export function getSingleFileState({ id = getUniqueId(), markdown, filename, pathname, options }) {
 ...
 */
export function createDocumentState(markdownDocument, id = getUniqueId()) {
...
function assertLineEnding(adjustLineEndingOnSave, lineEnding) {
